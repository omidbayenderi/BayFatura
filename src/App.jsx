...
const SeoLandingPage = React.lazy(() => import('./pages/seo/SeoLandingPage'));
  ...
  return (
    <PanelProvider>
      ...
      <Routes>
        ...
        {/* Super Admin — legacy DCC login page (kept; used by /superadmin) */}
        <Route path="/superadmin" element={<LazyRoute><SuperAdminLogin /></LazyRoute>} />

        {/* Programmatic SEO Landing Pages — generated by SEO Agent */}
        <Route path="/:lang/rechnung-erstellen/:slug" element={<LazyRoute><SeoLandingPage /></LazyRoute>} />
        <Route path="/:lang/criar-fatura/:slug"       element={<LazyRoute><SeoLandingPage /></LazyRoute>} />
        <Route path="/:lang/crear-factura/:slug"      element={<LazyRoute><SeoLandingPage /></LazyRoute>} />
        <Route path="/:lang/creer-facture/:slug"      element={<LazyRoute><SeoLandingPage /></LazyRoute>} />
        <Route path="/:lang/invoice-template/:slug"   element={<LazyRoute><SeoLandingPage /></LazyRoute>} />
